...
/// [ExpandableTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class _ExpandableTileState extends State<ExpandableTile> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    final color = _backgroundColor.value ?? Colors.transparent;
    return Material(
      color: color,
  ...
  void didChangeDependencies() {
    ...
    _headerColorTween
      ...
      ..end = widget.accent ?? theme.accentColor;
    _iconColorTween
