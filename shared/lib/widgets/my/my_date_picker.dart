...
class DayPicker extends StatelessWidget {
  ...
  DayPicker({
    ...
    this.dragStartBehavior = DragStartBehavior.start,
        ...
        assert(
            selectedDate.isAfter(firstDate) || selectedDate.isAtSameMomentAs(firstDate)),
        super(key: key);
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          itemStyle =
              themeData.textTheme.bodyText2!.copyWith(color: themeData.disabledColor);
...
class _MyDatePickerDialog extends StatefulWidget {
  ...
  @override
  _MyDatePickerDialogState createState() => _MyDatePickerDialogState();
}
    ...
    final Widget actions = ButtonBar(
      children: <Widget>[
        ...
        Padding(
          ...
          child: RaisedButton(
            child: Text(localizations.okButtonLabel.capitalize()),
            onPressed: _handleOk,
...
Future<DateTime?> showMyDatePicker({
  ...
  Widget child = _MyDatePickerDialog(
